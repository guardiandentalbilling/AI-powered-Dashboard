...
function getApiBaseUrl() {
    return localStorage.getItem('GLOBAL_API_BASE_URL') || 'http://localhost:5000/api';
}

function getGeminiApiKey() {
    return localStorage.getItem('GEMINI_API_KEY') || 'AIzaSyBI-1nm5J02NX1HBszEgeOClktTITPxAKc';
}
...
// Claims Follow-up API Functions
